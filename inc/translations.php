...
if (function_exists('pll_register_string')) :
    pll_register_string('Ξενοδοχεία', 'Ξενοδοχεία', true);
    pll_register_string('Εστιατόρια', 'Εστιατόρια', true);
    pll_register_string('Καφετέριες', 'Καφετέριες', true);
    pll_register_string('Μπάρ', 'Μπάρ', true);
    pll_register_string('Μουσεία', 'Μουσεία', true);
    pll_register_string('Ταξιδιωτικά γραφεία', 'Ταξιδιωτικά γραφεία', true);
    pll_register_string('Σύνδεση', 'Σύνδεση', true);
    pll_register_string('Εγγραφή', 'Εγγραφή', true);
