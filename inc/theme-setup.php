...
function volos_voyage_setup()
{
    /*
		...
		* If you're building a theme based on Volos Voyage, use a find and replace
		* to change 'volos-voyage' to the name of your theme in all the template files.
		*/
    load_theme_textdomain('volos-voyage', get_template_directory() . '/languages');
    ...
    add_theme_support(
        'custom-background',
        apply_filters(
            'volos_voyage_custom_background_args',
            array(
...
add_action('after_setup_theme', 'volos_voyage_setup');
