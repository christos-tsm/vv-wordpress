...
<section class="dashboard__container container container--medium">
    ...
    <div class="dashboard__content">
        ...
        <form class="form form--fluid" id="update-user-details-form" method="POST" action="<?= esc_url(admin_url('admin-post.php')); ?>">
            ...
            <div class="form-row">
                <div class="form-row form-row--col">
                    <label for="first_name"><?php pll_e('Όνομα') ?>*</label>
                ...
                <div class="form-row form-row--col">
                    <label for="last_name"><?php pll_e('Επίθετο') ?>*</label>
        ...
        <div class="change-password__container">
            <a href="#!" class="input btn pointer" id="btn-change-password"><?php pll_e('Αλλαγή κωδικού'); ?></a>
            <form class="form form--fluid" id="update-user-password-form" method="POST" action="<?= esc_url(admin_url('admin-post.php')); ?>">
                ...
                <div class="form-row form-row--col">
                    <label for="old_password"><?php pll_e('Τρέχον κωδικός'); ?>*</label>
                ...
                <div class="form-row">
                    <div class="form-row form-row--col">
                        <label for="new_password"><?php pll_e('Νέος κωδικός'); ?>*</label>
                    ...
                    <div class="form-row form-row--col">
                        <label for="confirm_password"><?php pll_e('Επιβεβαίωση νέου κωδικού'); ?>*</label>
                ...
                <div class="form-row form-row--submit">
                    <!-- <button id="update-user-password-form-submit" class="input btn pointer" type="submit"><?php pll_e('Ανανέωση κωδικού'); ?></button> -->
                </div>
