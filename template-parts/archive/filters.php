    ...
    <aside class="archive__filters">
        <div class="archive__categories">
            <ul class="archive__categories-list">
                <li data-id="-1" data-taxonomy="<?= esc_attr($taxonomy); ?>" data-type="<?= $post_type ?>" class="archive__categories-list-item archive__categories-list-item--active"><a href="#!"><?php _e('Όλες οι κατηγορίες'); ?></a></li>
