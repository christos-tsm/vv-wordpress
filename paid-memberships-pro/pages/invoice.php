...
<div class="<?php echo esc_attr(pmpro_get_element_class('pmpro_invoice_wrap')); ?>">
	...
	<p class="<?php echo esc_attr(pmpro_get_element_class('pmpro_actions_nav')); ?>">
		<span class="<?php echo esc_attr(pmpro_get_element_class('pmpro_actions_nav-right')); ?>">
			<a class="input btn" href="<?php echo esc_url(pmpro_url("account")) ?>">
		...
		<?php if ($pmpro_invoice) { ?>
			<span class="<?php echo esc_attr(pmpro_get_element_class('pmpro_actions_nav-left')); ?>">
				<a class="input btn" href="<?php echo esc_url(pmpro_url("invoice")) ?>">
					<?php pll_e('Όλα τα τιμολόγια'); ?>
